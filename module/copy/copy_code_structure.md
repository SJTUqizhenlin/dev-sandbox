...
`@lzx-sandbox/dev-sandbox/module/copy/copy_runtime.h`

后端实现按目录隔离：

`@lzx-sandbox/dev-sandbox/module/copy/ascend`

`@lzx-sandbox/dev-sandbox/module/copy/cuda`

`@lzx-sandbox/dev-sandbox/module/copy/simu`

CUDA GDR 扩展放在：

`@lzx-sandbox/dev-sandbox/module/copy/cuda/gdr`
...
`@lzx-sandbox/dev-sandbox/module/copy/cuda/copy_case_cuda.cc`

Simu case 示例：

`@lzx-sandbox/dev-sandbox/module/copy/simu/copy_case_simu.cc`
...
`@lzx-sandbox/dev-sandbox/module/copy/cuda/copy_buffer_cuda.h`

`@lzx-sandbox/dev-sandbox/module/copy/cuda/gdr/copy_buffer_gdr.h`

`@lzx-sandbox/dev-sandbox/module/copy/simu/copy_buffer_simu.h`
...
`@lzx-sandbox/dev-sandbox/module/copy/simu/copy_instance_simu.h`

`@lzx-sandbox/dev-sandbox/module/copy/cuda/copy_instance_cuda.h`
...
`@lzx-sandbox/dev-sandbox/module/copy/cuda/gdr/copy_instance_gdr.h`
...
`@lzx-sandbox/dev-sandbox/module/copy/cuda/copy_runtime_cuda.cc`

`@lzx-sandbox/dev-sandbox/module/copy/simu/copy_runtime_simu.cc`
...
`@lzx-sandbox/dev-sandbox/module/copy/cuda/gdr/rdma_channel_gdr.h`
...
3. `@lzx-sandbox/dev-sandbox/module/copy/copy_instance.h`
4. `@lzx-sandbox/dev-sandbox/module/copy/copy_buffer.h`
5. `@lzx-sandbox/dev-sandbox/module/copy/copy_result.h`
6. `@lzx-sandbox/dev-sandbox/module/copy/ascend/copy_case_ascend.cc`
7. `@lzx-sandbox/dev-sandbox/module/copy/ascend/copy_instance_ascend.h`
8. `@lzx-sandbox/dev-sandbox/module/copy/ascend/copy_case_ffts_d2d_ascend.cc`
9. `@lzx-sandbox/dev-sandbox/module/copy/ascend/copy_instance_ffts_pipeline_ascend.h`
